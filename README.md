...
When installation finishes, the full stack (OpenWebUI, phone bot, RAG, realtime voice server, etc.) starts automatically and **12 tools (including calendar, live whisper, voice engine settings, and memory anchor) are registered automatically**.
...
- 12 tools registered (including calendar, live whisper, voice engine settings, memory anchor)
