...
```bash
chmod +x setup-browser-agent-calendar-naver-search-only.sh
./setup-browser-agent-calendar-naver-search-only.sh
```
...
├── setup-browser-agent-calendar-naver-search-only.sh   # browser agent + calendar
