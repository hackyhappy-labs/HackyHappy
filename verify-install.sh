#!/bin/bash
# ╔══════════════════════════════════════════════════════════════════════╗
# ║  설치 검증 스크립트 — verify-install.sh  v5.3.0                     ║
...
# ║  - Browser: setup-browser-agent-browser-use-v7.sh (v6.x)          ║
# ║                                                                      ║
# ║  v5.3.0 변경사항 (v5.2.0 대비) — v7 스크립트 소스 재대조:          ║
# ║  - [교정] Browser 설치 스크립트 파일명 -v6.sh → -v7.sh (전 구간)   ║
# ║          (업로드 파일: setup-browser-agent-browser-use-v7.sh)       ║
...
declare -a DIR_LIST=(
  ...
  # ── Browser Agent: setup-browser-agent-browser-use-v7.sh ──
...
info "                     bash setup-browser-agent-browser-use-v7.sh"
